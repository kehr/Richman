...
//
// The returned object and its functions are memoized on hasCapital so that
// consumers (Dashboard decision card list, Portfolio table, etc.) that pass
// them into React.memo children or useEffect dependency arrays do not bust
